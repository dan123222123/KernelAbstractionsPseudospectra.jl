...
# 1e-14 F64) — the looser tol below is only for the rtol-bounded adaptive test.
...
# looser than the fixed-nit/eigtool reference. kwargs forward adaptive
...
function testihlpsa_adaptive(fname, backend, tol; kwargs...)
    ...
    srg, nit_grid = KernelAbstractionsPseudospectra._ihlpsa_adaptive(backend, zg, P; kwargs...)
