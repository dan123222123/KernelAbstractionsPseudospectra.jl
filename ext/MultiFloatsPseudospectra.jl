...
@inline @generated function KernelAbstractionsPseudospectra.KATRSM._trsm_shfl(
        v::MultiFloat{
            T, N}, src) where {T, N}
...
@inline KernelAbstractionsPseudospectra.KATRSM._trsm_shfl(v::Complex{<:MultiFloat}, src) = Complex(
    KernelAbstractionsPseudospectra.KATRSM._trsm_shfl(real(v), src),
    KernelAbstractionsPseudospectra.KATRSM._trsm_shfl(imag(v), src))
